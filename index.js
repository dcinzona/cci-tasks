// Description: This script is used to update the package version in the README file and sfdx-project.json file.
// Source: https://github.com/trailheadapps/github-action-sfdx-packaging-updater
...
async function run() {
    try {
        ...
        //exit if no package directories found
        if (!packageDirectories || !sfdxJson.packageAliases) {
            core.info("No valid packages found in sfdx-project.json... nothing to do.");
            return;
        }
        ...
        fs.writeFileSync("./sfdx-project.json", JSON.stringify(sfdxJson, null, 4).concat("\n"), "utf8");
